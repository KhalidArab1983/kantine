...
<body>
    ...
    <!-- <div class="b-example-divider" style="height: 1.5rem; margin: 20px 0px;"></div> -->
    <section>
        <div class="row">
        <footer class="py-3 bg-primary text-white text-center position-relative">
            <div class="container-fluid">
                <p class="lead">
